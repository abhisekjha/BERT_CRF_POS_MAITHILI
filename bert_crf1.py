...
# Collect tags
train_tags = collect_unique_tags('datasets/train1.txt')
validation_tags = collect_unique_tags('datasets/validation1.txt') if os.path.exists('datasets/validation1.txt') else set()
...
train_sentences, train_tags = read_train_data('datasets/train1.txt')
validation_sentences, validation_tags = read_train_data('datasets/validation1.txt')
